...
---
<div class="prose | content-grid | flow">
...
<a href="/Andrew-Cetnarskyj-Oct2025.pdf" download="Andrew-Cetnarskyj-Oct2025.pdf" type="application/pdf" class="button button--primary" aria-label="Download CV as PDF">Download CV</a>
</div>
...
Moving to [Phoenix Group](https://thephoenixgroup.com) I took on the challenge of migrating their brand guidelines and multiple products into a multi-brand and cross platform design system.
 ...
 In this role I work closely with product designers, developers to deliver component libraries in HTML/CSS and React Native. This runs alongside integrating our design system guidelines to AI tools and manage our [design system documentation site](https://compound.thephoenixgroup.com/).

## Side Projects
Throughout my career, I've always loved the technical side of digital design. I continue to build out small sites and side projects to keep my skills on point; you are more likely to find me in Codepen than Dribbble. Over the past two years I have been fortunate enough to provide my design skills to the fitness platform  [Street Parking](https://www.streetparking.com). I was one of their users for two years prior, so getting to work on a project I use daily is a true passion project.

Thanks for taking the time to check out my work, if you would like to discuss a project, please get in touch via [LinkedIn](https://www.linkedin.com/in/andrewcetnarskyj/) or download my CV above.
