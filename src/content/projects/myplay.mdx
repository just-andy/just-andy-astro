...
thumbnail: "../../images/projects/myplay/mp-thumbnail.jpeg"
banner: "../../images/projects/myplay/mp-banner.jpg"
order: 1300
featured: false
private: false
---
...
import mpScreenshots from "../../images/projects/myplay/mp-screenshots.jpeg";
import mpSketches from "../../images/projects/myplay/mp-sketches.jpeg";
import mpUi21 from "../../images/projects/myplay/mp-ui2-1.png";
import mpUi22 from "../../images/projects/myplay/mp-ui2-2.png";
import mpUi23 from "../../images/projects/myplay/mp-ui2-3.png";
...
<ImageText section="section--light full-width">
<Image src={mpScreenshots} alt="Screenshots of other betting apps" slot="image"/>
...
<ImageText>
<Image src={mpSketches} alt="Concept Sketches" slot="image"/>
...
<Gallery>
<Image src={mpUi21} alt="MyPlay UI Screen 1" />
<Image src={mpUi22} alt="MyPlay UI Screen 2" />
<Image src={mpUi23} alt="MyPlay UI Screen 3" />
</Gallery>
