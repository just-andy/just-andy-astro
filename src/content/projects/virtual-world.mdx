...
thumbnail: "../../images/projects/virtual-world/vw-thumbnail.jpg"
banner: "../../images/projects/virtual-world/vw-banner.jpg"
order: 700
featured: true
private: false
---
...
import vwGraph from "../../images/projects/virtual-world/vw-graph.jpg";
import vwTimeline from "../../images/projects/virtual-world/vw-timeline.jpg";
import vwWireframe from "../../images/projects/virtual-world/vw-wireframe.jpeg";
import vwUserfeedback from "../../images/projects/virtual-world/vw-userfeedback.jpeg";
import vwAdaptiveLayout from "../../images/projects/virtual-world/vw-adaptive-layout.jpeg";
...
<Image src={vwGraph} alt="Virtual world drop graph" slot="image"/>
...
<Image src={vwTimeline} alt="Timeline Analysis" />

<ImageText>
<Image src={vwWireframe} alt="Virtual World early wireframe" slot="image"/>
...
<ImageText section="section--light">
<Image src={vwUserfeedback} alt="Spotlight of User Feedback" slot="image"/>
...
<YouTube id="https://youtu.be/xZEYNTSV6_s" />

<ImageText>
<Image src={vwAdaptiveLayout} alt="Adaptive Layout Mockups" slot="image"/>
