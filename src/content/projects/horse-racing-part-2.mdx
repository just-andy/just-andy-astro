...
thumbnail: "../../images/projects/horse-racing-part-2/hr-part2-thumbnail.jpg"
banner: "../../images/projects/horse-racing-part-2/hr-2-header-background.jpg"
order: 400
featured: true
private: false
---
...
import hr2Usertest1 from "../../images/projects/horse-racing-part-2/hr2-usertest-1.jpeg";
import hr2OptimalSort from "../../images/projects/horse-racing-part-2/hr2-optimal-sort.jpeg";
import hr2Desktop from "../../images/projects/horse-racing-part-2/hr2-desktop.png";
...
<Image src={hr2Usertest1} alt="User Testing Lab" slot="image" />
...
<ImageText section="section--light">
<Image src={hr2OptimalSort} alt="Optimal Sort outputs" slot="image" />
...
<ImageText>
<Image src={hr2Desktop} alt="Desktop mockup" slot="image" />
...
This project was still in the development phase when I left the company. However, the rigorous testing with a wide spectrum of users gives me confidence that this will gain William Hill more wallet share from the avid horse racing customer and <a href="../projects/horse-racing-part-1" title="Horse Racing Case Study 1">meet the goals of our initial workshop</a>.
